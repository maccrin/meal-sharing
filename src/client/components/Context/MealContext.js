...
const MealProvider = ({ children }) => {
    const [currentMeals, dispatchMeals] = useReducer(mealReducer, { data: [], isLoading: false, isError: false })
    ...
    return (
        <div>
            <MealContext.Provider value={{ currentMeals, dispatchMeals }}>{children}</MealContext.Provider>
